...
- Where do you copy it? ~/etc/ansible# nano elk.yml
- Which file do you update to make Ansible run the playbook on a specific machine? Update the hosts file (nano), include the server name (ELK), and IP address (ELK).
