...
- Which URL do you navigate to in order to check that the ELK server is running? [To access Kibana go to: http://ELK ip address:port-number/app/kibana] [Click the link below] 
