...
- Which URL do you navigate to in order to check that the ELK server is running? Go to Kibana and enter the following: (http://ELK ip address:port-number/app/kibana), if the site succesfuly loads you have successfully configured the ELK server. 
- [Click the link below to check a sample of the site] 
